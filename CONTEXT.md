...
| Nazi ✓ | **納粹** | 12 句 |
| orichalcum ✓ | **奧利哈剛** | 亞特蘭提斯傳說金屬(音譯)。物件 `bead`=**金珠**(實際撿到的珠子);材質名 `orichalcum`=奧利哈剛 |
...
**印第安納·瓊斯的口吻 + 黑色幽默。** 對白不是平鋪直敘的字面翻譯,要還原印第這個角色:

- **冷面俏皮話(wisecrack)**:印第面對危險、屍體、納粹、超自然時習慣用挖苦、自嘲、不在乎的語氣帶過。翻譯保留那股「都火燒眉毛了還能吐槽」的勁。
- **黑色幽默**:死亡、陷阱、怪物的場景,用冷調反差製造笑點(例:看到 Sternhart 的屍體不必沉重,印第會用幾近冷血的調侃)。
- **1940s 冒險片節奏**:印第與蘇菲亞一路鬥嘴,你來我往、互不相讓;蘇菲亞嘴利、不是花瓶。對白的拍子要快、要有來有往。
- **不要過度正經、不要翻譯腔**:寧可口語、帶台味機鋒,也不要生硬直譯。但**地名 / 物件名 / 謎題關鍵字**(柏拉圖、世界之石、orichalcum…)要精確,玩家得靠它解謎。
- **粗話 / 威脅 / 納粹台詞**:納粹反派講話可帶官腔與冷硬;印第回敬時更顯其痞勁。

> 一句話:**字面對、語氣痞、危險時還能開玩笑。** 細節譯名照下表,但「怎麼說」照這節。
...
## 1990s 官方術語 oracle(本機參考,gitignore)

兩份 1990s 中文攻略已整理成 Markdown,作為時代術語 + 流程 + 物件名對照:

- **[`docs/攻略.md`](docs/攻略.md)** — 作者「青衫」,**逐步流程**,三條路線全。物件旁附英文名(角型雕像=horned statue…)。
- **[`docs/攻略-提示.md`](docs/攻略-提示.md)** — 作者「曾昭朋」,**漸進式提示**(雙人模式)。問題語氣本身就是**印第口吻範本**(見上「對話風格」)。
- 兩份用詞略異(日石/太陽石盤、金珠/能源石…),表內已對照。**人名 / 拼字一律以遊戲語料為準**(攻略有 OCR 與人工翻譯誤差,如 Kerner 在攻略先以 Smith 偽裝出現)。
- ⚠️ 攻略為第三方著作,只本機參考、不入庫(合理引用)。
